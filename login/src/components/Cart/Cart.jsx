      ...
      <div className="encapsule">
        <header>
          <div className="continue-shopping">
            ...
            <h3><i class="fa-sharp fa-solid fa-arrow-left fa-2xl" onClick={handleBack} style={{cursor: "pointer"}}></i>&nbsp; &nbsp;continue shopping</h3>
          </div>
          <div className="cart-icon">
            {/* <img src="./public-images/cart-image.png" alt="cart" /> */}
